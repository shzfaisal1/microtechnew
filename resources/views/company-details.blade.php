							    	...
							    	<div class="card">
							    		...
							    		<div class="card-body">
                                            <div class="row">
                                            	...
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">Company Prefix :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            </div>
                                            ...
                                            <div class="row">
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">City <span class="text-danger">*</span> :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
                                            ...
                                            <div class="row">
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">PAN No <span class="text-danger">*</span> :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">PT No :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
                                            ...
                                            <div class="row">
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">Web Address <span class="text-danger">*</span> :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
                                            ...
                                            <div class="row">
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">Service Tax No <span class="text-danger">*</span> :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
                                            	    <div class="form-group">
                                            	        <label for="uname">Licence No :</label>
                                            	        <input type="text" class="form-control" placeholder="">
                                            	    </div>
                                            	</div>
                                            	<div class="col">
