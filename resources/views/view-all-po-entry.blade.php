...
<div class="page-header">
	<div class="page-leftheader">
		<h4 class="page-title">View All PO Entry</h4>
                                                ...
                                                <table id="example" class="table table-striped table-bordered w-100">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="wd-15p">PO Date</th>
                                                            <th class="wd-15p">Vendor</th>
                                                            <th class="wd-15p">Contact Person</th>
                                                            <th class="wd-15p">Contact Person Phone</th>
                                                            <th class="wd-15p">Quantity</th>
                                                            <th class="wd-15p">Total Amount</th>
                                                            <th class="wd-15p">INR Amount</th>
                        ...
                        <div class="search-client-info">
                            <div class="row">
							    <div class="col-lg-12 col-md-12">
							    	<div class="card">
                                        <div class="card-header">
							    			<h3 class="card-title">Missing Invoice No List</h3>
							    		</div>
							    		<div class="card-body">
                                            <div class="table-responsive">
