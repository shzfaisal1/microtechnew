...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title">Designation Details</h4>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="designation">Add Designation<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="designation" placeholder="" name="designation" value="{{ old('designation', $designation->designation) }}" required>
