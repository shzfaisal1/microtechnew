...
<!-- search-client-info -->
<form action="{{route('buyer.update',$buyer_data->id)}}" method="POST">
    @csrf
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="buyer_name">Add Buyer<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="buyer_name" placeholder="" name="buyer_name" value="{{ $buyer_data->buyer_name }}">
                                </div>
                            </div>
