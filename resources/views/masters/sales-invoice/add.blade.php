    ...
    <div class="col-md-4 mb-3">
        ...
        <div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="invoice_type" id="type_gst" value="gst"
                       {{ old('invoice_type', 'gst') == 'gst' ? 'checked' : '' }} required>
                <label class="form-check-label" for="type_gst">GST Invoice</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="invoice_type" id="type_vat" value="vat"
                       {{ old('invoice_type') == 'vat' ? 'checked' : '' }}>
                <label class="form-check-label" for="type_vat">VAT/Service TAX</label>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-4 mb-3">
        ...
        <select class="form-control select2" id="financial_id" name="financial_id">
            ...
            @foreach($financial as $fy)
                <option value="{{ $fy->id }}" {{ old('financial_id') == $fy->id ? 'selected' : '' }}>
                    {{ $fy->financial_year }}
                </option>
            @endforeach
        </select>
