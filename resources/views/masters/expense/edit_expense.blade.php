...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title">Expense Type Details</h4>
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Expense Type Details</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="report_type">Expense Type<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="report_type" placeholder="" value="{{ $data->expense }}" name="expense" >
                                </div>
                            </div>
