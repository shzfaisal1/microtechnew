            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Tax Details</h3>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tax_name" placeholder="" name="tax_name" value="{{ old('company_name', $company->company_name ?? '') }}">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" placeholder="Tax Value" name="tax_value" id="tax_value" title="Please enter Tax Value">
                                    </div>
                                </div>
                            </div>
                            <br>
