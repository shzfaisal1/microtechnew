...
<!-- search-client-info -->
<form action="{{route('report.update',$edit_val->id)}}" method="POST">
    @csrf
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Edit Report Type</h3>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="report_type" placeholder="" value="{{ $edit_val->report_type }}" name="report_type" >
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
