            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Invoice Type</h3>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @if(session('add_invoice_type'))

                        <div class="alert alert-success">
                            {{session('add_invoice_type')}}
                        </div>
                        @endif
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="invoice_type" placeholder="" name="invoice_type" >
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Stamp Description" name="stamp_description" id="stamp_description" title="Please Stamp Description">
                                    </div>
                                </div>
                            </div>
                             ...
                             <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="Stamp Description" name="unstamp_description" id="unstamp_description" title="Please Unstamp Description">
                                    </div>
                                </div>
                            </div>
                        </div>
