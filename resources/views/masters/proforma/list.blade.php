        ...
        <div class="col-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    ...
                    <h5 class="mb-3">Proforma</h5>
                    <div class="table-responsive">
                        <table id="proforma_table" class="table table-bordered table-striped w-100">
...
$(document).ready(function () {
 ...
 let table = $('#proforma_table').DataTable({
     pageLength: 10,
    filter: true,
    deferRender: true,
    scrollY: 200,
  ...
  columns: [
    ...
    { data: 'pl_no', name: 'pl_no' },
    { data: 'pl_date', name: 'pl_date' },
    ...
    { data: 'contact_period_from', name: 'contact_period_from' },
    { data: 'contact_period_to', name: 'contact_period_to' },
    { data: 'proforma_type', name: 'proforma_type' },
    { data: 'challan', name: 'challan' },
