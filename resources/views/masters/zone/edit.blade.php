...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title">Zone Details</h4>
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Update Zone Details</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="name">Add Zone<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="name" placeholder="" name="name" value="{{ old('name', $zone->name) }}" required>
                                </div>
                            </div>
