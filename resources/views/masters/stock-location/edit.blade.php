            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add Stock Details</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="location_name">Add Stock Location<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="location_name" placeholder="Enter stock location" name="location_name" value="{{ $stockLocation->location_name ?? old('location_name') }}" required>
                                    @error('location_name')
