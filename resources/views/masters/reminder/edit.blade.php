...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title">Reminder Details</h4>
...
<!-- search-client-info -->
<form action="{{route('reminder.update',$reminder_data->id)}}" method="POST">
    @csrf
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Update Reminder Details</h3>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="reminder_value">Add Reminder<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="reminder_value" placeholder="" name="reminder_value"  value="{{ $reminder_data->reminder_value }}">
                                </div>
                            </div>
