...
<!-- search-client-info -->
<form action="{{route('consignee.update',$data->id)}}" method="POST">
    @csrf
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Update Consignee</h3>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        @if(session('update_consignee'))

                        <div class="alert alert-success">
                            {{session('update_consignee')}}
                        </div>
                        @endif
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-group">
                                    <label for="name">Add Consignee<span class="text-danger">*</span> :</label>
                                   
                                    <input type="text" class="form-control p-2" id="name" placeholder="" name="name" value="{{ $data->name }}">
                                </div>
                            </div>
